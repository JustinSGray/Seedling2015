...
\subsubsection{Illustration of the IGA modeling capabilities}
    ...
    locations, propeller placement, and wing construction methods. 
    ...
    loads for the wing, and the skin carries essentially no loads at all. 

    \begin{figure}[!hbt]
            \centering
            \includegraphics[width=.5\textwidth]{images/wing-construction}
