...
\begin{document}
  ...
  \section{Introduction}
    ...
    performed to validate structural models and construction techniques. During phase II, two 
    ...
    \begin{figure}[!hbt]
        \subfloat[Twin-fuselage Chimera UAV]{
            \centering
            \label{fig:chimera}
            \includegraphics[width=\textwidth]{images/drone2}}
            
        \subfloat[FrankenEye UAV]{
            \centering
            \label{fig:FrankenEye}
            \includegraphics[width=\textwidth]{images/drone3}}
...
\section{Team Structure and Management}
    ...
    led by AeroVelo where the team will all review the conceptual design of the aircraft and work to establish the proper baselines 
 ...
 \end{landscape}
    \subsection{Milestones}
        \begin{table}\begin{tabular}{lcl}
            ...
            Structural Testing          & 7/15/2015 & Complete structural testing and CFOSS integration \\
            ...
            Detailed Design Report       & 9/30/2015 & Detailed design and dynamic model for Marathon Airplane \\
            \textit{ \textbf{Year 2}} & \\
            ...
            Final report                & 11/30/2016 & All Code/Design/Docs Published \\
