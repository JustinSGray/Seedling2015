...
\begin{document}
  ...
  \section{Introduction}
    ...
    and Stanford University. In 2013 AeroVelo won the Sikorski Human Powered Helicopter Prize. Their next human powered aircraft will be 
    built to conquer the Kremer Marathon Challenge; fly a human powered aircraft 26.1 miles in under 1 hour. 
  ...
  \section{Objectives and Technical Approach}
    ...
    the results within a vary small timeframe. 
    ...
    NASA Armstrong Research Center, Georgia Tech, and AeroVelo will all collaborate on a set of structural validation 
    ...
    Figure ~\ref{fig:n2} shows details of how the multidiscplinary coupling will be set up. The aerodynamics 
    ...
    wind turbine design [CITATION NEEDED]. The small satellite design problem had over 25,000 design variables 
  ...
  \section{Innovation \& Impact}
    ...
    The Kremer marathon challenege was established in 1959, and has remained unmet for the last 55 years. 
    ...
    mulidisciplinary design research. 
    ...
    effort we gain the opportunity to iterate not just on the aircraft design but also on the design process itself. We'll be
    able to improve the usefulness of optimization tools by tailoring them to support a traditional iterative design loop. 
    So the work proposed here will yield a large amount of information on how to better integrate multidisciplinary methods 
    into the aerospace community at large. 
...
\section{Team Structure and Management}
    ...
    The NASA team members come from three different NASA Centers. The other team members come from three different external 
    organizations. Table \ref{tab:nasa-team} summarizes the team members and their responsibilities. 
    ...
    \begin{table}
        ...
        \begin{tabular}{lll}
            ...
            Dr. Graeme Kennedy & \bigcell{l}{Georgia Institute \\ of Technology} & ???? \\
            Dr. Juan Alonso & Stanford & ???? \\
