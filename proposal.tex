...
\subsubsection{Illustration of the IGA modeling capabilities}
    ...
    \subsection{Aircraft Design}
        ...
        combination of thin mylar and foam. The foam is used on the upper surface leading edge to help retain the correct airfoil 
        ...
        loads for the wing, and the skin carries essentially no loads at all. Figure~\ref{fig:traditional-wing-construction} shows
        the Atlas rotor blades including the spars, ribs, skin, and foam leading edges. 

        \begin{figure}[!hbt]
                \centering
                \includegraphics[width=.75\textwidth]{images/wing-construction}
                \caption{Rotor blades from the Atlas human powered helicopter using a spar and rib based construction 
                method}
    ...
    \subsection{Structural Testing \& Model Validation}
        ...
        \begin{figure}[!htbp]
            \centering
<<<<<<< HEAD
            \includegraphics[width=.7\textwidth]{images/follower_force}
            \caption{Loads applied normal to the surface is important for large deflections}
            \label{fig:follower-force}
=======
            \includegraphics[width=.5\textwidth]{images/follower_force}
            \caption{The upper diagram shows loads applied in a single direction, as demonstrated in Figure~\ref{fig:spar-load-test}.However, loads applied normal to the surface, as shown in the lower diagram, are important for large deflections.}
>>>>>>> 58c875994d7ddebe9280a0fcdc2e27c53e8b465f
        \end{figure}
 ...
 \end{landscape}
    \subsection{Milestones}
        \begin{table}\begin{tabular}{lcl}
            ...
            Aircraft Geometry           & 11/30/2014 & \bigcell{l}{parametric geometry model for the aircraft, \\ including structural model}  \\
            ...
            Structural Testing          & 4/30/2015 & Complete structural test report \\
            \bigcell{l}{Aero-Propulsive-Elastic \\ Optimization} & 8/30/2015 & Completed optimization of vehicle \\
            Preliminary Design           & 1/30/2015 & Conceptual design report for Marathon Aircraft  \\
